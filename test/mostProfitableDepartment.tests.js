...
describe('Test mostProfitableDepartment function' , function(){
    it('It should return Outdoor for most profitable department in dataset 1' , function(){
        assert.deepEqual("outdoor",mostProfitableDepartment(salesData), 'Outdoor');
    });
    
    it('It should return Electronics for most profitable department in dataset 2' , function(){
        assert.deepEqual("electronics",mostProfitableDepartment(salesData2), 'Electronics');
    });
